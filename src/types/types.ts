...
export type RenderReason =
  | { type: 'initial-mount'; confidence: 'confirmed' }
  | { type: 'prop-changed'; field?: string; confidence: 'confirmed' | 'possible' }
  | { type: 'function-prop-changed'; field: string; confidence: 'confirmed' | 'possible' }
  | { type: 'object-prop-changed'; field?: string; confidence: 'confirmed' | 'possible' }
  | { type: 'array-prop-changed'; field?: string; confidence: 'confirmed' | 'possible' }
  | { type: 'state-changed'; field?: string; confidence: 'confirmed' | 'possible' }
  | { type: 'context-changed'; contextName: string; confidence: 'confirmed' | 'possible' }
  | { type: 'parent-rendered'; confidence: 'confirmed' | 'possible' }
