...
import { renderStore, trackRender, pushParentRendered } from './core/renderStore';
import { consoleReporter } from './reporters/consoleReporter';
const isDevelopment = process.env.NODE_ENV !== 'production';
export const RenderGuardian = (props) => {
    const { enabled = isDevelopment, track, ignore, maxHistory, panel, consoleReporter: consoleReporterProp, rules, onRuleViolation, reporter, logLevel = 'info', autoTrack, } = props;
