import { RenderEvent, RenderReason, PropChange, GuardianSuggestion } from '../types';
...
export declare function trackRender(componentName: string, duration?: number, parentRendered?: boolean, propChanges?: PropChange[], contextChanges?: string[], isInitialMount?: boolean): RenderEvent;
